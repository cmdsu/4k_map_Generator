...
def main():
    ...
    parser.add_argument("--chart_type", type=str, default="rice", choices=["rice", "ln"])
    ...
    parser.add_argument("--music_influence", type=float, default=1.0, help="Music-fit influence from 0.0 to 1.0. Defaults to 1.0.")
    ...
    if not args.skip_audio_analysis and args.offset is None:
    ...
    chord_enabled = chord_enabled_for(args.chart_type, key_style, {})
    _, _, default_chord = max_chord_bounds_for(args.chart_type, key_style, {})
    ...
    config = DifficultyConfig(
        ...
        max_anchor_length=3,
        hand_balance=0.5,
        ln_ratio=ln_ratio if args.chart_type == "ln" else 0.0,
        min_ln_ms=120,
        max_ln_ms=1000,
